      ...
      <Flex alignItems='center' justifyContent='space-between'>
        <Box width='100%'>
          ...
          <div>
            <Flex alignItems='center'>
              <Box mr={2}>
                <Box height={10} width={10} borderRadius={9999} bg='#509E71' />
              </Box>
              <div>
                <Text fontFamily='Lato' color='#B1A3B4'>
                  Kenichi Okiebisu
                </Text>
              </div>
            </Flex>
        ...
        <Box>
          <Box bg='white' height={35} width={35} borderRadius={9999}>
            <Flex justifyContent='center' alignItems='center'>
              <svg height={16} viewBox='0 0 20 20'>
