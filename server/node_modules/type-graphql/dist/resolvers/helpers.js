...
function getParams(params, resolverData, globalValidate, pubSub) {
    const paramValues = params
        ...
        switch (paramInfo.kind) {
            case "args":
                return validate_arg_1.validateArg(convert_args_1.convertArgsToInstance(paramInfo, resolverData.args), globalValidate, paramInfo.validate);
            case "arg":
                return validate_arg_1.validateArg(convert_args_1.convertArgToInstance(paramInfo, resolverData.args), globalValidate, paramInfo.validate);
            case "context":
