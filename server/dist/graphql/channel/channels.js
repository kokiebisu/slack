...
let ChannelsResolver = class ChannelsResolver {
    channels(teamId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const channels = yield Channel_1.Channel.find({ where: { teamId } });
                return {
                    ok: true,
                    channels,
                };
...
__decorate([
    ...
    type_graphql_1.Query(() => channelResponse_1.ChannelsResponse),
    __param(0, type_graphql_1.Arg('teamId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ChannelsResolver.prototype, "channels", null);
