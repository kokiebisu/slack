...
__decorate([
    typeorm_1.ManyToOne(() => User_1.User, (user) => user.channelMembers),
    __metadata("design:type", User_1.User)
], ChannelMember.prototype, "user", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Channel_1.Channel, (channel) => channel.channelMembers),
    __metadata("design:type", Channel_1.Channel)
], ChannelMember.prototype, "channel", void 0);
ChannelMember = __decorate([
    type_graphql_1.ObjectType(),
    typeorm_1.Entity('channel_members')
], ChannelMember);
